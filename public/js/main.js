...
var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.innovation__content', (_Swiper = {
  slidesPerView: 'auto'
}, _defineProperty(_Swiper, "slidesPerView", 4), _defineProperty(_Swiper, "spaceBetween", 30), _defineProperty(_Swiper, "loop", true), _defineProperty(_Swiper, "navigation", {
  nextEl: '.innovation__btn--next',
  prevEl: '.innovation__btn--prev'
}), _Swiper));
